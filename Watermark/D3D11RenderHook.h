 ...
 */
template <typename T>
MH_STATUS MH_CreateHookEx(LPVOID pTarget, LPVOID pDetour, T** ppOriginal)
{
	return MH_CreateHook(pTarget, pDetour, reinterpret_cast<LPVOID*>(ppOriginal));
}

using Present_t = HRESULT(__fastcall*)(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags);
/**< Type definition for Present function pointer. */
using ResizeBuffers_t = HRESULT(__fastcall*)(IDXGISwapChain* pSwapChain, UINT BufferCount, UINT Width, UINT Height,
                                             DXGI_FORMAT NewFormat,
                                             UINT SwapChainFlags);
/**< Type definition for ResizeBuffers function pointer. */
...
public:
	 ...
	 */
	HRESULT ResizeBuffers(IDXGISwapChain* pSwapChain, UINT BufferCount, UINT Width, UINT Height, DXGI_FORMAT NewFormat,
	                      UINT SwapChainFlags);
	 ...
	 * @return HRESULT indicating the result of resizing.
	 */
	static HRESULT __fastcall ResizeBuffersStub(IDXGISwapChain* pSwapChain, UINT BufferCount, UINT Width, UINT Height,
...
private:
	...
	std::string m_watermarkData; /**< Watermark text data. */
	...
	ID3D11BlendState* m_pBlendState; /**< Pointer to the blend state. */
