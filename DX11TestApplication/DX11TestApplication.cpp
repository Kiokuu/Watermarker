// This is a simple example of how to create a window and render a triangle using Direct3D 11.
// The code is taken from the public domain demo by Kevin Moran.
// https://github.com/kevinmoran/BeginnerDirect3D11/blob/master/02.%20Drawing%20a%20Triangle/main.cpp

// The purpose of this example is to provide a simple DX11 application that can be used to test the Binder application.
...
#include <assert.h>
#include "DX11TestApplicationShader.h"
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int /*nShowCmd*/)
{
    ...
    ID3D11VertexShader* vertexShader;
    {
        ...
        HRESULT hResult = D3DCompile(shaderSrc, strlen(shaderSrc), nullptr, nullptr, nullptr, "vs_main", "vs_5_0", 0, 0, &vsBlob, &shaderCompileErrorsBlob);
        if(FAILED(hResult))
        {
    ...
    ID3D11PixelShader* pixelShader;
    {
        ...
        HRESULT hResult = D3DCompile(shaderSrc, strlen(shaderSrc), nullptr, nullptr, nullptr, "ps_main", "ps_5_0", 0, 0, &psBlob, &shaderCompileErrorsBlob);
        if(FAILED(hResult))
        {
            const char* errorString = NULL;
            if(hResult == HRESULT_FROM_WIN32(ERROR_FILE_NOT_FOUND))
