...
void ResizeImGuiWindow(int width, int height);
...
int ImguiHandler::initialize()
{
    ...
    g_hWnd = CreateWindowW(wc.lpszClassName, L"Binder", WS_OVERLAPPEDWINDOW, 100, 100, g_windowSize.x, g_windowSize.y, nullptr, nullptr, wc.hInstance, nullptr);
...
LRESULT WINAPI WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SIZE:
        if (g_pd3dDevice!=nullptr && wParam != SIZE_MINIMIZED)
        {
            ...
            ResizeImGuiWindow(LOWORD(lParam), HIWORD(lParam));
        }
        return 0;
    case WM_SYSCOMMAND:
